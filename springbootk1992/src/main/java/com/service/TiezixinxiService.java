...
public interface TiezixinxiService extends IService<TiezixinxiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<TiezixinxiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<TiezixinxiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<TiezixinxiEntity> wrapper);
