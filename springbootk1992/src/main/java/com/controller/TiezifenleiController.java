...
public class TiezifenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TiezifenleiEntity tiezifenlei,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TiezifenleiEntity tiezifenlei, 
		HttpServletRequest request){
        EntityWrapper<TiezifenleiEntity> ew = new EntityWrapper<TiezifenleiEntity>();
