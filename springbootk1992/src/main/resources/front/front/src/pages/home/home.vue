...
<div class="home-preview" :style='{"width":"1200px","margin":"0 auto","background":"none"}'>
	<el-row type="flex" :gutter="5" justify="center" style="width: 100%">
		...
		<el-col :span="3" v-if="queryIndex==0">
			<el-input v-model="tiezixinxitiezibiaoti" placeholder="帖子标题"></el-input>
		</el-col>
		<el-col :span="3" v-if="queryIndex==0">
			<el-button type="primary" @click="search('tiezixinxi')">搜索</el-button>
		</el-col>
	</el-row>
...
<div class="recommend" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"8px","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","justifyContent":"space-between"}'>
    ...
    <div class="title" :style='{"width":"auto","padding":"0px","margin":"0px ","lineHeight":"54px","textAlign":"left","order":"0"}'>
		<span :style='{"padding":"10px","borderColor":"#55b44b","fontSize":"32px","color":"#000","borderStyle":"solid","borderWidth":" 0 0 5px 0"}'>帖子信息推荐</span>
	</div>
	...
	<div class="list list1 index-pv1" :style='{"padding":"0px","margin":"20px 0 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto","order":"2"}'>
		<div :style='{"border":"0px solid #bee4cc","padding":"4px","margin":"8px 0","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"19%","position":"relative","height":"auto"}' v-for="(item,index) in tiezixinxiRecommend" :key="index" @click="toDetail('tiezixinxiDetail', item)" class="list-item animation-box">
			<img :style='{"border":"1px solid #bee4cc","width":"100%","objectFit":"contain","borderRadius":"0","display":"block","height":"220px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
			<img :style='{"border":"1px solid #bee4cc","width":"100%","objectFit":"contain","borderRadius":"0","display":"block","height":"220px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
			<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto","borderColor":"#e1f6e9","color":"#333","textAlign":"center","background":"#f1fdf5","borderWidth":"0 0 1px 0","display":"block","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}'>{{item.tiezibiaoti}}</div>
			<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto","borderColor":"#e1f6e9","color":"#333","textAlign":"center","background":"#f1fdf5","borderWidth":"0 0 1px 0","display":"block","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}'>{{item.tiezifenlei}}</div>
			<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto","borderColor":"#e1f6e9","color":"#333","textAlign":"center","background":"#f1fdf5","borderWidth":"0 0 1px 0","display":"block","width":"100%","lineHeight":"30px","fontSize":"14px","borderStyle":"solid"}'>{{item.nicheng}}</div>
		</div>
	</div>
	...
	<div @click="moreBtn('tiezixinxi')" :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0","textAlign":"center","display":"block","float":"right","borderRadius":"30px","background":"#3db769","width":"auto","lineHeight":"40px","height":"40px","order":"0"}'>
...
<div class="news" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","borderRadius":"8px","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","justifyContent":"space-between"}'>
	...
	<div class="title" :style='{"width":"auto","padding":"0px","margin":"0px  ","lineHeight":"54px","textAlign":"left","order":"0"}'>
		<span :style='{"padding":"10px","borderColor":"#55b44b","fontSize":"32px","color":"#000","borderStyle":"solid","borderWidth":" 0 0 5px 0"}'>公告资讯</span>
	</div>
...
<script>
  export default {
    ...
    methods: {
      ...
      search(tablename) {
        if (this.queryIndex == 0 && this.tiezixinxitiezibiaoti) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.tiezixinxitiezibiaoti}});
        }
      },
		getNewsList() {
		...
		getList() {
          let autoSortUrl = "";
          autoSortUrl = "tiezixinxi/autoSort";
			this.$http.get(autoSortUrl, {params: {
				...
				if (res.data.code == 0) {
					this.tiezixinxiRecommend = res.data.data.list;
