...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"2px solid #a4d9b7","padding":"10px 0","margin":"10px 0 0 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(100% - 130px)","float":"right","height":"auto"}'>
      ...
      <el-form-item :style='{"margin":"10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#29292a","display":"inline-block"}'>姓名</div>
        <el-input v-model="formSearch.xingming" placeholder="姓名" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"10px"}'>
		<div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#29292a","display":"inline-block"}'>性别</div>
	  ...
	  <el-button v-if="isAuth('yonghu','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"10px","outline":"none","color":"#fff","borderRadius":"10px","background":"#55b44b","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/yonghuAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"calc(100% - 130px)","float":"right","margin":"20px 0"}'>
		...
		<div class="list2 index-pv1" :style='{"border":"2px solid #a4d9b7","padding":"20px 0px 0 0px","overflow":"hidden","borderRadius":"8px","background":"#fff","width":"100%","height":"auto"}'>
			<div :style='{"cursor":"pointer","margin":"0 0 20px 2%","borderRadius":"10px","flexWrap":"wrap","background":"#fff","display":"flex","width":"48%","fontSize":"0","float":"left","height":"150px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"boxShadow":"8px 0px 0 rgba(146, 181, 164,.5)","borderColor":"rgba(146, 181, 164,.8)","objectFit":"contain","borderRadius":"10px 40px 40px 10px","borderWidth":"1px 12px 1px 1px","width":"240px","borderStyle":"solid","float":"left","height":"100%"}' v-if="item.touxiang && item.touxiang.substr(0,4)=='http'" :src="item.touxiang" class="image" />
				<img :style='{"boxShadow":"8px 0px 0 rgba(146, 181, 164,.5)","borderColor":"rgba(146, 181, 164,.8)","objectFit":"contain","borderRadius":"10px 40px 40px 10px","borderWidth":"1px 12px 1px 1px","width":"240px","borderStyle":"solid","float":"left","height":"100%"}' v-else :src="baseUrl + (item.touxiang?item.touxiang.split(',')[0]:'')" class="image" />
